...
0x296,0x2A0,0x2A3,0x2AB,0x26,0x3E,0x54,0x36,0x76,0x206,0x238,0x20E,0}
)

group_sprite_triplets = ({0x203,0x223,0X2A8,0x250,0x253,0x258,0x213,0x160,0xE4,0x1D4,0x200,0x208,0x20B,0x228,0x22B,0x230,0x220,0x210,0x218,0x21B} |
sr3(0x1A0,0x1A6) |
sr3(0x1A8,0x1AE) |
sr3(0x1B0,0x1B6) |
sr3(0x2B0,0x2B6) |
