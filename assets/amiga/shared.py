...
sprite_pairs = (sr2(0,0x30) | # player
...
sr2(0xA8,0xBC) | # jumping skeleton / zombie
sr2(0xE0,0xE4) | # bat
sr2(0xE8,0xEC) | # bat
sr2(0x1C0,0x1D4) | # explosions
...
{0x168,0x1A6,0x1AE,0x22E,0x25C,0x275,0x26E,0x27D,0x286,0x28E,0x266,
0x296,0x2A0,0x2A3,0x2AB,0x2B1,0x26,0x3E}
)

sprite_triplets = ({0x2B3,0X2A8,0x250,0x253,0x258,0x160,0xE4,0x1D4,0x200,0x208,0x20B,0x228,0x22B,0x230,0x220,0x210,0x214,0x218,0x21B} |
sr3(0x1A0,0x1A6) |
sr3(0x1A8,0x1AE) |
sr3(0x1B0,0x1B6) |
sr3(0x1B8,0x1BE) |
...
sprite_quadrulplets = sr4(0x2C0,0x300)
