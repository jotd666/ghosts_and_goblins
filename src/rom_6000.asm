...
compute_screen_start_address_6381:
6381: CE 28 0F    LDU    #$280F
6384: D6 FF       LDB    $FF
6386: C5 01       BITB   #$01
6388: 27 04       BEQ    $638E
638A: 33 C9 02 00 LEAU   $0200,U	; starts right half
638E: C5 20       BITB   #$20
6390: 27 03       BEQ    $6395
6392: 33 C8 10    LEAU   $10,U		; starts bottom half
6395: 39          RTS

6396: E6 13       LDB    -$D,X
6398: 58          ASLB
6399: CE 63 9E    LDU    #jump_table_639e
639C: 6E D5       JMP    [B,U]		 ; [indirect_jump] [nb_entries=7]
...
660B: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=4]

update_tiles_palette_6619:
6619: 96 DE       LDA    tiles_palette_change_command_00de
661B: 26 39       BNE    change_ram_palette_6656
661D: 10 DF E2    STS    stack_save_00e2	; save current stack
6620: CE 16 32    LDU    #tiles_palette_in_ram_1632		; load U (red+green)
6623: 32 C8 40    LEAS   $40,U		; set stack to U+$40 (blue+filler)
...
66E4: 33 CB       LEAU   D,U
66E6: 10 DF E2    STS    stack_save_00e2
...
6855: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=4]
...
6878: 0F 70       CLR    $70
687A: C6 01       LDB    #$01
687C: D7 DE       STB    tiles_palette_change_command_00de
687E: D7 DF       STB    $DF
...
68A5: 4F          CLRA
68A6: 5F          CLRB
68A7: DD DE       STD    tiles_palette_change_command_00de
68A9: C6 01       LDB    #$01
68AB: D7 F0       STB    $F0
...
6953: AD 96       JSR    [A,X]		; [indirect_jump] [nb_entries=8]
...
6A02: 6E 95       JMP    [B,X]		; [indirect_jump] [nb_entries=2]
...
6A53: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=3]
...
6A93: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=4]
 
6A9D: D6 0B       LDB    sub_sub_sub_state_000b
6A9F: 58          ASLB
6AA0: 8E 6A A5    LDX    #jump_table_6aa5
6AA3: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=3]
...
6B63: 48          ASLA
6B64: 6E 96       JMP    [A,X]	; [indirect_jump] [nb_entries=3]
...
6BA4: C6 01       LDB    #$01
6BA6: D7 DE       STB    tiles_palette_change_command_00de
...
6D3F: E6 02       LDB    $2,X
6D41: 4F          CLRA
6D42: DD E2       STD    stack_save_00e2
6D44: E6 03       LDB    $3,X
6D46: DD E4       STD    $E4
...
6D59: 84 1F       ANDA   #$1F
6D5B: 5F          CLRB
6D5C: D3 E2       ADDD   stack_save_00e2
6D5E: ED 16       STD    -$A,X
6D60: DC 91       LDD    $91
6D62: 58          ASLB
6D63: 49          ROLA
...
6D9F: C6 28       LDB    #$28
6DA1: D7 93       STB    $93
6DA3: D7 E2       STB    stack_save_00e2
...
6DB7: 0A E2       DEC    stack_save_00e2
6DB9: 26 EF       BNE    $6DAA
6DBB: DF 94       STU    $94
...
6DD4: C6 06       LDB    #$06
6DD6: D7 A7       STB    $A7
6DD8: D7 E2       STB    stack_save_00e2
...
711B: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=4]
...
724B: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=2]

7251: D6 0E       LDB    $0E                                         
7253: 58          ASLB                                               
7254: CE 72 59    LDU    #jump_table_7259
7257: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
738F: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=4]
...
7416: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
7455: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=7]
...
755D: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=6]
...
758A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
7679: DD E4       STD    $E4
767B: C6 03       LDB    #$03
767D: D7 E2       STB    stack_save_00e2
767F: EE 84       LDU    ,X
7681: 33 5C       LEAU   -$4,U
7683: EC A1       LDD    ,Y++
...
7782: 6E 95       JMP    [B,X]        ; [indirect_jump] [nb_entries=3]

778A: D6 0E       LDB    $0E
778C: 58          ASLB
778D: 8E 77 92    LDX    #jump_table_7792
7790: 6E 95       JMP    [B,X]        ; [indirect_jump] [nb_entries=2]

7796: CC 00 78    LDD    #$0078
7799: DD 0C       STD    $0C
779B: 0C 0E       INC    $0E
779D: 9E 0C       LDX    $0C
779F: 30 1F       LEAX   -$1,X
...
7819: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
78D3: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7A76: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7AE2: 6E D6       JMP    [A,U]		; [indirect_jump] [nb_entries=4]
...
7B34: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
7B54: EE 1C       LDU    -$4,X
7B56: E6 C0       LDB    ,U+
7B58: D7 DE       STB    tiles_palette_change_command_00de
7B5A: E6 C0       LDB    ,U+
...
7B8B: 58          ASLB
7B8C: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7BD6: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=5]
...
7C48: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=5]
...
7CA6: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
7CD4: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=7]
...
7D56: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
7DD6: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
7DF9: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7E14: C6 0E       LDB    #$0E
7E16: D7 DE       STB    tiles_palette_change_command_00de
...
7E48: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7EAF: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
7EFF: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=2]
...
7F15: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=5]
...
7FC2: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]
...
802A: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=3]
...
80A9: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=3]

80AB: 58          ASLB
80AC: CE 80 B1    LDU    #jump_table_80b1
80AF: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
8508: E6 C4       LDB    ,U		; [bank_address]
850A: 4F          CLRA
850B: 58          ASLB
850C: 49          ROLA
850D: 10 8E 42 00 LDY    #$4200
8511: EC AB       LDD    D,Y		; [bank_address]
8513: DD E0       STD    $E0
...
8808: E6 C4       LDB    ,U		; [bank_address]
880A: 4F          CLRA
880B: 58          ASLB
880C: 49          ROLA
880D: 10 8E 42 00 LDY    #$4200
8811: EC AB       LDD    D,Y		; [bank_address]
8813: DD E0       STD    $E0
...
8ABC: 34 10       PSHS   X
8ABE: C6 08       LDB    #$08
8AC0: D7 E2       STB    stack_save_00e2
8AC2: C6 00       LDB    #$00
8AC4: F7 3E 00    STB    bankswitch_3e00
8AC7: E6 C4       LDB    ,U		; [bank_address]
8AC9: 33 48       LEAU   $8,U
8ACB: 4F          CLRA
8ACC: 58          ASLB
8ACD: 49          ROLA
...
8ADB: A6 05       LDA    $5,X		; [bank_address]
8ADD: E6 07       LDB    $7,X		; [bank_address]
8ADF: ED A8 30    STD    $30,Y
8AE2: A6 01       LDA    $1,X		; [bank_address]
8AE4: E6 03       LDB    $3,X		; [bank_address]
8AE6: ED A1       STD    ,Y++
8AE8: 0A E2       DEC    stack_save_00e2
8AEA: 26 D6       BNE    $8AC2
...
8B2F: A7 A4       STA    ,Y		; [video_address]
8B31: 31 A8 20    LEAY   counter_16_bit_0020,Y
8B34: A6 C0       LDA    ,U+
8B36: A7 84       STA    ,X		; [video_address]
...
8CD6: A6 A5       LDA    B,Y		; [bank_address]
8CD8: 27 06       BEQ    $8CE0
8CDA: E6 A5       LDB    B,Y		; [bank_address]
8CDC: D0 E9       SUBB   $E9
8CDE: 24 37       BCC    $8D17
8CE0: EC 7E       LDD    -$2,S
...
8D0D: 27 06       BEQ    $8D15
8D0F: E6 A5       LDB    B,Y		; [bank_address]
8D11: D0 E9       SUBB   $E9
8D13: 24 02       BCC    $8D17
8D15: 4F          CLRA
8D16: 39          RTS
...
8D3B: 31 A5       LEAY   B,Y
8D3D: 6D A4       TST    ,Y	; [bank_address]
8D3F: 27 06       BEQ    $8D47
8D41: D6 E8       LDB    $E8
8D43: E0 A4       SUBB   ,Y	; [bank_address]
8D45: 24 02       BCC    $8D49
8D47: 5F          CLRB
8D48: 39          RTS
8D49: 1A 01       ORCC   #$01
...
8D63: 26 10       BNE    $8D75
8D65: 97 E8       STA    $E8
8D67: E6 A4       LDB    ,Y	; [video_address]
8D69: 10 8E 44 C0 LDY    #$44C0
8D6D: E6 A5       LDB    B,Y	; [bank_address]
8D6F: 27 04       BEQ    $8D75
8D71: D0 E8       SUBB   $E8
8D73: 24 02       BCC    $8D77
8D75: 5F          CLRB
...
8F9C: D7 DE       STB    tiles_palette_change_command_00de
8F9E: DC 91       LDD    $91
8FA0: 58          ASLB
8FA1: 49          ROLA
8FA2: 58          ASLB
...
8FA7: 33 CB       LEAU   D,U	; [bank_address]
8FA9: A6 43       LDA    $3,U	; [bank_address]
...
8FBE: D7 DE       STB    tiles_palette_change_command_00de
...
8FF9: 0C E1       INC    $E1
8FFB: DD E2       STD    stack_save_00e2
8FFD: DC E4       LDD    $E4
8FFF: A3 19       SUBD   -$7,X
9001: DD E4       STD    $E4
9003: 2A 0D       BPL    $9012
...
906B: E6 1E       LDB    -$2,X
906D: 58          ASLB
906E: EC C5       LDD    B,U		; [select_address]
9070: ED 84       STD    ,X
9072: 6F 02       CLR    $2,X
9074: E6 02       LDB    $2,X
9076: 26 1F       BNE    $9097
...
90C5: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=6]
...
9133: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
9176: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
9320: C4 C0       ANDB   #$C0
9322: 26 EB       BNE    $930F
9324: E6 A4       LDB    ,Y	; [video_address]
9326: C0 40       SUBB   #$40
9328: C1 3D       CMPB   #$3D
932A: 22 E3       BHI    $930F
932C: 54          LSRB
...
935C: C4 C0       ANDB   #$C0
935E: 26 AF       BNE    $930F
9360: E6 A4       LDB    ,Y	; [video_address]
9362: C0 40       SUBB   #$40
9364: C1 3D       CMPB   #$3D
...
94B1: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
952C: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=3]
952E: 7E 94 DD    JMP    $94DD
9531: BD 95 82    JSR    $9582
9534: E6 14       LDB    -$C,X
9536: 58          ASLB
9537: CE 95 3C    LDU    #jump_table_953c
953A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
957A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
997C: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
99E0: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
9A84: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
9B03: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=5]
9B05: E6 0E       LDB    $E,X
9B07: 5A          DECB
...
9C3D: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=7]
...
9C8B: EC 13       LDD    -$D,X
9C8D: 48          ASLA
9C8E: AD D6       JSR    [A,U]        ; [special_indirect_jump] [nb_entries=4]
...
9CC6: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=6]
...
9D79: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=5]
...
9E67: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=6]

9E75: 58          ASLB
9E76: CE 9E 7B    LDU    #jump_table_9e7b
9E79: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
9EA0: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
9FC3: A6 57       LDA    -$9,U
9FC5: E6 5A       LDB    -$6,U
9FC7: DD E2       STD    stack_save_00e2
...
9FEF: 90 E2       SUBA   stack_save_00e2
9FF1: 9B E4       ADDA   $E4
9FF3: 91 E5       CMPA   $E5
9FF5: 22 47       BHI    $A03E
...
A072: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A0C7: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=19]
...
A0DB: EC 13       LDD    -$D,X
A0DD: 48          ASLA
A0DE: CE A0 E3    LDU    #jump_table_a0e3
A0E1: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]
...
A0EF: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
A153: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A185: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]

A18B: E6 1E       LDB    -$2,X
A18D: 58          ASLB
A18E: CE 45 6A    LDU    #$456A
A191: EE C5       LDU    B,U	; [bank_address]
A193: EC C1       LDD    ,U++	; [bank_address]
A195: A7 1F       STA    -$1,X
A197: E7 0D       STB    $D,X
A199: EC C1       LDD    ,U++	; [bank_address]
A19B: ED 03       STD    $3,X
A19D: EF 0E       STU    $E,X
A19F: 6C 15       INC    -$B,X
A1A1: 39          RTS
...
A1A4: 26 10       BNE    $A1B6
A1A6: EE 0E       LDU    $E,X
A1A8: EC C1       LDD    ,U++	; [bank_address]
A1AA: 2B 0B       BMI    $A1B7
A1AC: A7 1F       STA    -$1,X
A1AE: E7 0D       STB    $D,X
A1B0: EC C1       LDD    ,U++	; [bank_address]
A1B2: ED 03       STD    $3,X
A1B4: EF 0E       STU    $E,X
A1B6: 39          RTS
...
A1C3: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A1DC: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A244: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=8]
A246: E6 1E       LDB    -$2,X
A248: CE 47 98    LDU    #$4798
A24B: 58          ASLB
A24C: EC C5       LDD    B,U	; [bank_address]
A24E: ED 84       STD    ,X
A250: 6F 02       CLR    $2,X
...
A288: C6 08       LDB    #$08
A28A: ED 0C       STD    $C,X
A28C: A6 98 0E    LDA    [$0E,X]		; [bank_address]
A28F: A7 0B       STA    $B,X
A291: 6C 15       INC    -$B,X
A293: 39          RTS
A294: 86 FF       LDA    #$FF
...
A29E: C6 08       LDB    #$08
A2A0: ED 0C       STD    $C,X
A2A2: A6 98 0E    LDA    [$0E,X]		; [bank_address]
A2A5: A7 0B       STA    $B,X
A2A7: 6C 15       INC    -$B,X
A2A9: 39          RTS
...
A2F8: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
A379: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=2]
...
A3E5: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A463: 58          ASLB
A464: EE C5       LDU    B,U	; [bank_address]
...
A4D3: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=6]

A4E1: 58          ASLB
A4E2: CE A4 E7    LDU    #jump_table_a4e7
A4E5: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A549: 33 C5       LEAU   B,U
A54B: EC 09       LDD    $9,X
A54D: E3 C4       ADDD   ,U		; [bank_address]
A54F: ED 09       STD    $9,X
A551: 24 15       BCC    $A568
A553: E6 08       LDB    $8,X
A555: C9 00       ADCB   #$00
...
A570: E6 09       LDB    $9,X
A572: 4F          CLRA
A573: E6 CB       LDB    D,U		; [bank_address]
A575: 2A 02       BPL    $A579
A577: 50          NEGB
A578: 4C          INCA
A579: 58          ASLB
A57A: 97 E2       STA    stack_save_00e2
A57C: A6 0C       LDA    $C,X
A57E: 3D          MUL
A57F: 1F 89       TFR    A,B
A581: 4F          CLRA
A582: DD E4       STD    $E4
A584: D6 E2       LDB    stack_save_00e2
A586: E8 08       EORB   $8,X
A588: C4 01       ANDB   #$01
A58A: 26 06       BNE    $A592
A58C: EC 06       LDD    $6,X
...
A5FE: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]

A606: E6 15       LDB    -$B,X
A608: 58          ASLB
A609: CE A6 0E    LDU    #jump_table_a60e
A60C: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A646: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]

A650: E6 15       LDB    -$B,X
A652: 58          ASLB
A653: CE A6 58    LDU    #jump_table_a658
A656: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A67F: E6 1E       LDB    -$2,X
A681: 58          ASLB
A682: EE C5       LDU    B,U		; [bank_address]
A684: 33 44       LEAU   $4,U
A686: EF 84       STU    ,X
A688: EF 03       STU    $3,X
A68A: 6F 02       CLR    $2,X
...
A6F0: 4F          CLRA
A6F1: E6 CB       LDB    D,U		; [bank_address]
A6F3: 58          ASLB
A6F4: A6 0C       LDA    $C,X
A6F6: 3D          MUL
A6F7: 1F 89       TFR    A,B
...
A707: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A729: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A75B: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A7E4: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A816: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]

A81C: E6 15       LDB    -$B,X
A81E: 58          ASLB
A81F: CE A8 24    LDU    #jump_table_a824
A822: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A843: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]

A849: E6 15       LDB    -$B,X
A84B: 58          ASLB
A84C: CE A8 51    LDU    #jump_table_a851
A84F: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
A864: EE C6       LDU    A,U
A866: EC 46       LDD    $6,U	; [bank_address]
A868: ED 84       STD    ,X
A86A: ED 03       STD    $3,X
A86C: 6F 02       CLR    $2,X
A86E: 39          RTS
...
A873: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
A8A2: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]

A8AC: E6 12       LDB    -$E,X
A8AE: 58          ASLB
A8AF: CE A8 B4    LDU    #jump_table_a8b4
A8B2: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]

A8BA: E6 14       LDB    -$C,X
A8BC: 58          ASLB
A8BD: CE A8 C2    LDU    #jump_table_a8c2
A8C0: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
AB5C: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=4]
...
AB75: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
ABD5: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
AC46: E6 15       LDB    -$B,X
AC48: 58          ASLB
AC49: CE AC 4E    LDU    #jump_table_ac4e
AC4C: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
ACD9: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
AEA5: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
AED4: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
B002: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]
...
B07B: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=3]
...
B11B: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
B14C: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]

B156: E6 12       LDB    -$E,X
B158: 58          ASLB
B159: CE B1 5E    LDU    #jump_table_b15e
B15C: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]

	
B164: E6 14       LDB    -$C,X                  
B166: 58          ASLB
B167: CE B1 6C    LDU    #jump_table_b16c
B16A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
B1CB: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
B23C: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=6]
B23E: 8D 1E       BSR    $B25E
B240: 8D 03       BSR    $B245
...
B27C: AD D5       JSR    [B,U]    ; [indirect_jump] [nb_entries=4]
...
B30F: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=4]
...
B375: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
B3D3: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
B5FD: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]

B603: 58          ASLB
B604: CE B6 09    LDU    #jump_table_b609
B607: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
B654: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]

B65E: 58          ASLB
B65F: CE B6 64    LDU    #jump_table_b664
B662: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
B683: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
B6DB: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=5]
...
B754: EE C5       LDU    B,U	; [bank_address]
B756: EC C1       LDD    ,U++	; [bank_address]
B758: ED 0A       STD    $A,X
...
B767: EE C5       LDU    B,U	; [bank_address]
B769: A6 C0       LDA    ,U+	; [bank_address]
B76B: A7 06       STA    $6,X
B76D: EF 88 18    STU    $18,X
B770: CE 4A 34    LDU    #$4A34
B773: EE C5       LDU    B,U	; [bank_address]
B775: A6 C0       LDA    ,U+	; [bank_address]
B777: A7 07       STA    $7,X
B779: EF 88 1A    STU    $1A,X
B77C: CE 4A 47    LDU    #$4A47
B77F: EE C5       LDU    B,U	; [bank_address]
B781: A6 C0       LDA    ,U+	; [bank_address]
B783: A7 08       STA    $8,X
...
B7CA: E6 0D       LDB    $D,X
B7CC: 58          ASLB
B7CD: EE C5       LDU    B,U	; [bank_address]
B7CF: 7E 90 6B    JMP    $906B

B7D6: 58          ASLB
B7D7: CE B7 F4    LDU    #jump_table_b7f4
B7DA: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=7]
...
B808: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=2]
...
B907: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
B91A: E6 0D       LDB    $D,X
B91C: 58          ASLB
B91D: EE C5       LDU    B,U		; [bank_address]
B91F: E6 1E       LDB    -$2,X
B921: 58          ASLB
B922: EC C5       LDD    B,U		; [bank_address]
B924: ED 03       STD    $3,X
B926: C6 05       LDB    #$05
B928: E7 02       STB    $2,X
B92A: 6C 12       INC    -$E,X
...
BA02: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=7]
BA04: E6 15       LDB    -$B,X
BA06: C0 02       SUBB   #$02
BA08: C1 01       CMPB   #$01
BA0A: 22 06       BHI    $BA12
...
BADB: 24 0A       BCC    $BAE7
BADD: E6 98 1C    LDB    [$1C,X]		; [bank_address]
BAE0: E7 08       STB    $8,X
BAE2: 4F          CLRA
BAE3: 5F          CLRB
BAE4: ED 14       STD    -$C,X
...
BB05: E3 19       ADDD   -$7,X
BB07: ED 19       STD    -$7,X
BB09: E6 98 1C    LDB    [$1C,X]		; [bank_address]
BB0C: E7 08       STB    $8,X
BB0E: 4F          CLRA
BB0F: 5F          CLRB
BB10: ED 14       STD    -$C,X
...
BB2D: E6 15       LDB    -$B,X
BB2F: 58          ASLB
BB30: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=4]
...
BB83: E6 98 18    LDB    [$18,X]		; [bank_address]
BB86: E7 06       STB    $6,X
BB88: A6 0C       LDA    $C,X
BB8A: 48          ASLA
...
BBAB: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=2]
...
BC26: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
BC7C: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=6]
BC7E: E6 15       LDB    -$B,X
BC80: C0 02       SUBB   #$02
BC82: C1 01       CMPB   #$01
BC84: 22 06       BHI    $BC8C
...
BD30: 4F          CLRA
BD31: E6 CB       LDB    D,U	; [bank_address]
BD33: 58          ASLB
...
BD53: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=6]
...
BDF5: 4F          CLRA
BDF6: E6 CB       LDB    D,U	; [bank_address]
BDF8: 58          ASLB
BDF9: D7 E1       STB    $E1
...
BE4F: 4F          CLRA
BE50: E6 CB       LDB    D,U	; [bank_address]
BE52: 58          ASLB
BE53: D7 E1       STB    $E1
...
BE9A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
BEDB: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]

BEE5: EC 14       LDD    -$C,X
BEE7: 48          ASLA
BEE8: CE BE ED    LDU    #jump_table_beed
BEEB: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=2]

BEF1: C6 0A       LDB    #$0A                                         
BEF3: E7 88 14    STB    $14,X                                        
BEF6: C6 04       LDB    #$04
BEF8: E7 1F       STB    -$1,X
BEFA: 6F 1E       CLR    -$2,X
BEFC: EC 16       LDD    -$A,X
...
BF46: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
BF4C: E6 15       LDB    -$B,X                                      
BF4E: 58          ASLB
BF4F: CE BF 57    LDU    #jump_table_bf57
BF52: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=4]
...
BF95: CE 4C 6D LDU    #$4C6D
BF98: BD 90 6B JSR    $906B
BF9B: 6C 15       INC    -$B,X
...
C087: EC C6       LDD    A,U	; [bank_address]
C089: ED 84       STD    ,X
C08B: ED 03       STD    $3,X
C08D: E7 02       STB    $2,X
C08F: 39          RTS
...
C093: 33 C5       LEAU   B,U
C095: EC 17       LDD    -$9,X
C097: E3 C4       ADDD   ,U		; [select_address]
C099: ED 17       STD    -$9,X
C09B: E6 C4       LDB    ,U		; [select_address]
C09D: 1D          SEX
C09E: A9 16       ADCA   -$A,X
C0A0: A7 16       STA    -$A,X
C0A2: 39          RTS
...
C0C7: AD D5       JSR    [B,U]  ; [indirect_jump] [nb_entries=5]
...
C1F0: EE C5       LDU    B,U	; [bank_address]
...
C202: 4F          CLRA
C203: E6 CB       LDB    D,U	; [bank_address]
C205: 58          ASLB
C206: A6 06       LDA    $6,X
C208: 3D          MUL
C209: 1F 89       TFR    A,B
...
C3A9: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
C3DB: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]

C3E3: E6 15       LDB    -$B,X
C3E5: 58          ASLB
C3E6: CE C3 EB    LDU    #jump_table_c3eb
C3E9: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
C40B: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
C44E: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
C4F0: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

C4FA: 58          ASLB                                               
C4FB: CE C5 00    LDU    #jump_table_c500
C4FE: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
C547: 54          LSRB
C548: 54          LSRB
C549: EE C5       LDU    B,U	; [bank_address]
C54B: E6 C0       LDB    ,U+	; [bank_address]
...
C58D: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
C613: EE C5       LDU    B,U	; [bank_address]
C615: EF 84       STU    ,X
C617: EF 03       STU    $3,X
C619: 6F 02       CLR    $2,X
C61B: C6 28       LDB    #$28
...
C62C: EE C5       LDU    B,U	; [bank_address]
C62E: EF 84       STU    ,X
C630: EF 03       STU    $3,X
C632: 6F 02       CLR    $2,X
C634: C6 19       LDB    #$19
...
C7CB: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=8]
...
C7F6: 58          ASLB
C7F7: EE C5       LDU    B,U	; [bank_address]
C7F9: EF 84       STU    ,X
C7FB: EF 03       STU    $3,X
...
C9E4: 58          ASLB
C9E5: EE C5       LDU    B,U	; [bank_address]
C9E7: EF 84       STU    ,X
C9E9: EF 03       STU    $3,X
...
CBE1: 58          ASLB
CBE2: EE C5       LDU    B,U	; [bank_address]
CBE4: EF 84       STU    ,X
CBE6: EF 03       STU    $3,X
CBE8: A6 0A       LDA    $A,X
CBEA: 26 06       BNE    $CBF2
...
CBFC: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
CC4B: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

CC55: 58          ASLB                                                
CC56: CE CC 5B    LDU    #jump_table_cc5b
CC59: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
CCAA: E6 15       LDB    -$B,X
CCAC: 58          ASLB
CCAD: CE CC B2    LDU    #jump_table_ccb2
CCB0: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
CD36: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=6]
...
CE40: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=5]
...
CE7B: E6 C5       LDB    B,U	; [bank_address]
...
CEF6: 4F          CLRA
CEF7: E6 CB       LDB    D,U	; [bank_address]
CEF9: 58          ASLB
...
CF0B: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=3]
...
CF3C: 6E D6       JMP    [A,U]        ; [indirect_jump] [nb_entries=4]

CF46: 58          ASLB
CF47: CE CF 4C    LDU    #jump_table_cf4c
CF4A: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
CF88: 54          LSRB
CF89: 54          LSRB
CF8A: EE C5       LDU    B,U	; [bank_address]
CF8C: E6 C0       LDB    ,U+	; [bank_address]
CF8E: E7 09       STB    $9,X
CF90: EF 0A       STU    $A,X
...
CFAE: AD D5       JSR    [B,U]        ; [indirect_jump] [nb_entries=4]
CFB0: E6 12       LDB    -$E,X
CFB2: 27 0D       BEQ    $CFC1
...
CFD0: 6E D5       JMP    [B,U]        ; [indirect_jump] [nb_entries=2]
...
CFF4: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
D0D6: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=5]
...
D1DB: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=4]
...
D2A4: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
D2E3: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

D2ED: 58          ASLB
D2EE: CE D2 F3    LDU    #jump_table_d2f3
D2F1: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]

D2F7: E6 15       LDB    -$B,X
D2F9: 58          ASLB
D2FA: CE D2 FF    LDU    #jump_table_d2ff
D2FD: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=4]
...
D380: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
D3D4: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=2]
D3D6: 7E 8F 62    JMP    $8F62

D3DD: E6 15       LDB    -$B,X
D3DF: 58          ASLB
D3E0: CE D3 E5    LDU    #jump_table_d3e5
D3E3: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
D4AD: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
D4ED: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
D51E: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

D528: A6 12       LDA    -$E,X
D52A: 48          ASLA
D52B: CE D5 30    LDU    #jump_table_d530
D52E: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=3]

D536: 58          ASLB
D537: CE D5 3C    LDU    #jump_table_d53c
D53A: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
D565: 58          ASLB
D566: EE C5       LDU    B,U		; [bank_address]
D568: EF 84       STU    ,X
D56A: EF 03       STU    $3,X
D56C: 6F 02       CLR    $2,X
...
D5B9: 33 84       LEAU   ,X
D5BB: DF E2       STU    stack_save_00e2
D5BD: BD 8D FC    JSR    $8DFC
D5C0: DE E2       LDU    stack_save_00e2
...
D5FB: 0A E1       DEC    $E1
D5FD: 26 BC       BNE    $D5BB
D5FF: DF E2       STU    stack_save_00e2
D601: BD 8D FC    JSR    $8DFC
D604: DE E2       LDU    stack_save_00e2
...
D6DC: AD D6       JSR    [A,U]	; [indirect_jump] [nb_entries=3]
...
D710: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]

D716: A6 15       LDA    -$B,X
D718: 48          ASLA
D719: CE D7 1E    LDU    #jump_table_d71e
D71C: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=5]
...
D76F: EE C4       LDU    ,U		; [bank_address]
D771: EC C1       LDD    ,U++	; [bank_address]
D773: A7 0A       STA    $A,X
D775: E7 1E       STB    -$2,X
D777: EF 08       STU    $8,X
...
D7FB: 58          ASLB
D7FC: EE C5       LDU    B,U		; [bank_address]
D7FE: EF 03       STU    $3,X
D800: C6 0A       LDB    #$0A
D802: E7 02       STB    $2,X
...
D8AC: 48          ASLA
D8AD: EE C6       LDU    A,U		; [bank_address]
D8AF: EF 08       STU    $8,X
D8B1: C8 01       EORB   #$01
D8B3: E7 88 14    STB    $14,X
D8B6: 58          ASLB
D8B7: CE 51 82    LDU    #$5182
D8BA: EE C5       LDU    B,U		; [bank_address]
D8BC: EF 84       STU    ,X
D8BE: EF 03       STU    $3,X
D8C0: 6F 02       CLR    $2,X
D8C2: EE 08       LDU    $8,X
...
D9AB: EE C5       LDU    B,U		; [bank_address]
D9AD: EF 84       STU    ,X
D9AF: EF 03       STU    $3,X
D9B1: 6F 02       CLR    $2,X
D9B3: C6 0A       LDB    #$0A
...
D9F7: 58          ASLB
D9F8: EE C5       LDU    B,U		; [bank_address]
D9FA: EF 84       STU    ,X
D9FC: EF 03       STU    $3,X
D9FE: 6F 02       CLR    $2,X
DA00: 39          RTS
...
DA05: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=7]
...
DADF: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

DAE9: 58          ASLB
DAEA: CE DA EF    LDU    #jump_table_daef
DAED: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
DCE4: 48          ASLA
DCE5: EE C6       LDU    A,U		; [bank_address]
DCE7: A6 88 19    LDA    $19,X
DCEA: 6D 0D       TST    $D,X
DCEC: 27 02       BEQ    $DCF0
DCEE: 86 02       LDA    #$02
DCF0: 48          ASLA
DCF1: EE C6       LDU    A,U		; [bank_address]
DCF3: EF 84       STU    ,X
DCF5: EF 03       STU    $3,X
DCF7: 6F 02       CLR    $2,X
DCF9: 39          RTS
...
DD6B: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
DE26: EC 13       LDD    -$D,X
DE28: 48          ASLA
DE29: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
DE47: 54          LSRB
DE48: 54          LSRB
DE49: EE C5       LDU    B,U		; [bank_address]
DE4B: E6 C0       LDB    ,U+		; [bank_address]
DE4D: E7 0C       STB    $C,X
DE4F: EF 0A       STU    $A,X
...
DEBE: EC 13       LDD    -$D,X
DEC0: 48          ASLA
DEC1: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
DEEC: 54          LSRB
DEED: 54          LSRB
DEEE: EE C5       LDU    B,U		; [bank_address]
DEF0: E6 C0       LDB    ,U+		; [bank_address]
DEF2: E7 06       STB    $6,X
DEF4: EF 08       STU    $8,X
...
DF02: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
DF17: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
DF5F: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
DFA3: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
DFD8: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
E003: 54          LSRB
E004: 54          LSRB
E005: EE C5       LDU    B,U		; [bank_address]
E007: 96 21       LDA    counter_8_bit_0021
E009: 9B E0       ADDA   $E0
E00B: 84 03       ANDA   #$03
E00D: E6 C6       LDB    A,U		; [bank_address]
E00F: E7 06       STB    $6,X
E011: EF 08       STU    $8,X
E013: 4C          INCA
E014: E6 C6       LDB    A,U		; [bank_address]
E016: E7 07       STB    $7,X
E018: EF 0A       STU    $A,X
E01A: C6 04       LDB    #$04
...
E02B: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=5]
...
E044: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=4]
E046: E6 11       LDB    -$F,X
E048: 26 05       BNE    $E04F
...
E0A0: 26 14       BNE    $E0B6
E0A2: EE 0A       LDU    $A,X
E0A4: E6 C0       LDB    ,U+		; [bank_address]
E0A6: 2A 04       BPL    $E0AC
E0A8: EE C4       LDU    ,U		; [bank_address]
E0AA: C4 7F       ANDB   #$7F
E0AC: EF 0A       STU    $A,X
E0AE: E7 07       STB    $7,X
E0B0: E6 0C       LDB    $C,X
...
E0D8: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=5]
...
E1E8: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=5]
...
E22F: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=5]
...
E27F: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
E31B: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
E364: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
E374: E6 12       LDB    -$E,X
E376: 58          ASLB
E377: EE C5       LDU    B,U	; [select_address] can be bank or RAM
E379: EF 06       STU    $6,X
E37B: 4F          CLRA
E37C: 5F          CLRB
E37D: ED 08       STD    $8,X
...
E390: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=6]
...
E3F7: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=4]
E3F9: 39          RTS
...
E484: 26 12       BNE    $E498
E486: EE 06       LDU    $6,X
E488: EC C1       LDD    ,U++		; [bank_address]
E48A: A7 1E       STA    -$2,X
E48C: 5D          TSTB
E48D: 2A 04       BPL    $E493
E48F: EE C4       LDU    ,U		; [bank_address]
E491: C4 7F       ANDB   #$7F
E493: EF 06       STU    $6,X
E495: E7 08       STB    $8,X
E497: 39          RTS
...
E4A3: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]

E4A9: A6 15       LDA    -$B,X                                      
E4AB: 48          ASLA
E4AC: CE E4 B1    LDU    #jump_table_e4b1
E4AF: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=2]
...
E4F0: EC 1A       LDD    -$6,X
E4F2: E3 42       ADDD   $2,U		; [bank_address]
E4F4: ED 1A       STD    -$6,X
E4F6: E6 42       LDB    $2,U		; [bank_address]
E4F8: 1D          SEX
E4F9: A9 19       ADCA   -$7,X
E4FB: A7 19       STA    -$7,X
E4FD: EC 17       LDD    -$9,X
E4FF: E3 C4       ADDD   ,U		; [bank_address]
E501: ED 17       STD    -$9,X
E503: E6 C4       LDB    ,U		; [bank_address]
E505: 1D          SEX
E506: A9 16       ADCA   -$A,X
E508: A7 16       STA    -$A,X
E50A: 39          RTS
...
E511: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E5F2: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E639: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]
...
E679: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=4]
E67B: 7E 8F 62    JMP    $8F62

E686: CE E6 A8    LDU    #jump_table_e6a8                                     
E689: E6 15       LDB    -$B,X                                      
E68B: 58          ASLB
E68C: AD D5       JSR    [B,U]	; [indirect_jump] [nb_entries=2]
E68E: EE 0E       LDU    $E,X
E690: E6 50       LDB    -$10,U
E692: 27 0C       BEQ    $E6A0
E694: E6 53       LDB    -$D,U
...
E6AF: E6 12       LDB    -$E,X                                      
E6B1: E6 C5       LDB    B,U		; [bank_address]
E6B3: 27 07       BEQ    $E6BC
...
E6C4: 58          ASLB
E6C5: EC C5       LDD    B,U		; [bank_address]
E6C7: ED 06       STD    $6,X
E6C9: 6C 15       INC    -$B,X
E6CB: EE 0E       LDU    $E,X
E6CD: E6 06       LDB    $6,X
...
E6E2: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E736: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E79A: 58          ASLB
; picking bonus
E79B: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=20]
...
E826: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E860: 58          ASLB
E861: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E88B: 58          ASLB
E88C: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E8AC: 58          ASLB
E8AD: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
E8D5: 58          ASLB
E8D6: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
E97C: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=2]

E982: CE E9 88    LDU    #jump_table_e988
E985: 58          ASLB
E986: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
E9A8: EE 16       LDU    -$A,X
E9AA: 8D 40       BSR    $E9EC
E9AC: D7 E2       STB    stack_save_00e2
E9AE: C6 20       LDB    #$20
E9B0: 3D          MUL
E9B1: C3 06 90    ADDD   #$0690
E9B4: 1F 02       TFR    D,Y
E9B6: D6 E2       LDB    stack_save_00e2
E9B8: 58          ASLB
E9B9: 58          ASLB
E9BA: 58          ASLB
E9BB: 58          ASLB
...
E9EC: E6 C4       LDB    ,U		; [bank_address]
E9EE: A6 C0       LDA    ,U+		; [bank_address]
E9F0: 44          LSRA
E9F1: 44          LSRA
E9F2: 44          LSRA
E9F3: 44          LSRA
...
E9FB: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=2]
...
EA1B: 49          ROLA
EA1C: 33 CB       LEAU   D,U
EA1E: A6 43       LDA    $3,U	; [bank_address]
EA20: C6 01       LDB    #$01
EA22: ED 84       STD    ,X
EA24: 4F          CLRA
EA25: 5F          CLRB
...
EA3F: AD D6       JSR    [A,U]	; [indirect_jump] [nb_entries=3]
...
EA57: 33 C5       LEAU   B,U		; [bank_address]
EA59: D6 9A       LDB    $9A
EA5B: C4 30       ANDB   #$30
EA5D: 54          LSRB
EA5E: 54          LSRB
EA5F: 54          LSRB
EA60: EE C5       LDU    B,U		; [bank_address]
EA62: EF 0C       STU    $C,X
EA64: E6 1C       LDB    -$4,X
EA66: E7 1D       STB    -$3,X
EA68: 6C 13       INC    -$D,X
...
EA7F: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
EA99: EE C5       LDU    B,U		; [bank_address]
EA9B: E6 03       LDB    $3,X
EA9D: 58          ASLB
EA9E: EE C5       LDU    B,U		; [bank_address]
EAA0: E6 C0       LDB    ,U+		; [bank_address]
EAA2: E7 1A       STB    -$6,X
EAA4: E7 1B       STB    -$5,X
EAA6: EF 0E       STU    $E,X
EAA8: 6C 14       INC    -$C,X
...
EAB0: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=16]
EAB2: 39          RTS
EAB3: D6 93       LDB    $93
EAB5: 27 FB       BEQ    $EAB2
...
EAC6: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=32]
...
EBE6: 58          ASLB
EBE7: AD B5       JSR    [B,Y]	; [indirect_jump] [nb_entries=7]
EBE9: E7 52       STB    -$E,U
EBEB: 39          RTS
...
EC0F: E6 A5       LDB    B,Y
EC11: 53          COMB
EC12: D7 E2       STB    stack_save_00e2
EC14: 8D 1D       BSR    $EC33
EC16: D6 E2       LDB    stack_save_00e2
EC18: D4 E1       ANDB   $E1
EC1A: 27 F8       BEQ    $EC14
EC1C: 86 05       LDA    #$05
EC1E: 97 E1       STA    $E1
...
ECB3: 6D 84       TST    ,X
ECB5: 2B 04       BMI    $ECBB
ECB7: E3 C1       ADDD   ,U++		; [bank_address]
ECB9: 20 02       BRA    $ECBD
...
ECE6: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=3]
...
ED5E: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=2]
...
EE11: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=7]
...
EED6: 6E 95       JMP    [B,X]	; [indirect_jump] [nb_entries=7]
...
EF73: 58          ASLB
EF74: 3A          ABX
EF75: 9F E2       STX    stack_save_00e2
...
EF96: A4 84       ANDA   ,X
EF98: 27 79       BEQ    $F013
EF9A: 9E E2       LDX    stack_save_00e2
EF9C: EC 56       LDD    -$A,U
EF9E: A3 36       SUBD   -$A,Y
EFA0: E3 84       ADDD   ,X
...
F3D3: 58          ASLB
F3D4: EC 85       LDD    B,X
F3D6: DD E2       STD    stack_save_00e2
...
F3FC: 27 4A       BEQ    $F448
F3FE: 97 E6       STA    $E6
F400: 9E E2       LDX    stack_save_00e2
F402: E6 25       LDB    $5,Y
F404: 58          ASLB
F405: 58          ASLB
F406: 58          ASLB
...
F548: DF E2       STU    stack_save_00e2
...
F553: E4 51       ANDB   -$F,U
F555: 27 43       BEQ    $F59A
F557: 9E E2       LDX    stack_save_00e2
F559: E6 45       LDB    $5,U
F55B: 58          ASLB
F55C: 58          ASLB
F55D: 58          ASLB
...
F6C0: 58          ASLB
F6C1: 3A          ABX
F6C2: 9F E2       STX    stack_save_00e2
...
F6CD: E4 51       ANDB   -$F,U
F6CF: 27 3D       BEQ    $F70E
F6D1: 9E E2       LDX    stack_save_00e2
F6D3: EC 36       LDD    -$A,Y
F6D5: A3 56       SUBD   -$A,U
F6D7: E3 84       ADDD   ,X
...
F85F: E6 1F       LDB    -$1,X
F861: 58          ASLB
F862: 6E D5       JMP    [B,U]	; [indirect_jump] [nb_entries=11]

F890: D6 29       LDB    $29
F892: 27 15       BEQ    $F8A9
F894: 0A 29       DEC    $29
F896: EE 03       LDU    $3,X
F898: EC C4       LDD    ,U		; [select_address]
F89A: DA E4       ORB    $E4
F89C: ED A1       STD    ,Y++
F89E: D6 E7       LDB    $E7
F8A0: 50          NEGB
...
F907: D7 29       STB    $29
F909: EE 03       LDU    $3,X
F90B: EC C4       LDD    ,U		; [select_address]
F90D: DA E4       ORB    $E4
F90F: ED A4       STD    ,Y
F911: A6 42       LDA    $2,U		; [select_address]
F913: ED 24       STD    $4,Y
F915: A6 43       LDA    $3,U		; [select_address]
F917: A7 28       STA    $8,Y
F919: A6 44       LDA    $4,U		; [select_address]
F91B: A7 2C       STA    $C,Y
F91D: D6 E7       LDB    $E7
F91F: 50          NEGB
F920: C0 10       SUBB   #$10
...
F937: E7 2B       STB    $B,Y
F939: E7 2F       STB    $F,Y
F93B: AA 41       ORA    $1,U		; [select_address]
F93D: A7 29       STA    $9,Y
F93F: A7 2D       STA    $D,Y
...
F9E0: D7 29       STB    $29
F9E2: EE 03       LDU    $3,X
F9E4: EC C4       LDD    ,U		; [bank_address]
F9E6: DA E4       ORB    $E4
F9E8: ED A4       STD    ,Y
F9EA: A6 42       LDA    $2,U		; [bank_address]
F9EC: A7 24       STA    $4,Y
F9EE: A6 43       LDA    $3,U		; [bank_address]
F9F0: A7 28       STA    $8,Y
F9F2: D6 E7       LDB    $E7
F9F4: 50          NEGB
F9F5: C0 10       SUBB   #$10
...
FA06: 97 E4       STA    $E4
FA08: E7 27       STB    $7,Y
FA0A: AA 41       ORA    $1,U		; [bank_address]
FA0C: A7 25       STA    $5,Y
FA0E: C3 00 10    ADDD   #$0010
FA11: 84 01       ANDA   #$01
FA13: 97 E4       STA    $E4
FA15: E7 2B       STB    $B,Y
FA17: AA 41       ORA    $1,U		; [bank_address]
FA19: A7 29       STA    $9,Y
FA1B: 31 2C       LEAY   $C,Y
FA1D: 39          RTS

; final boss, maybe optimize later?
FA1E: D6 29       LDB    $29
FA20: C0 10       SUBB   #$10
FA22: 25 F9       BCS    $FA1D
FA24: D7 29       STB    $29
FA26: EE 03       LDU    $3,X
FA28: EC C4       LDD    ,U		; [select_address]
FA2A: DA E4       ORB    $E4
FA2C: ED A4       STD    ,Y
FA2E: A6 42       LDA    $2,U		; [select_address]
FA30: ED 24       STD    $4,Y
FA32: A6 43       LDA    $3,U		; [select_address]
FA34: ED 28       STD    $8,Y
FA36: A6 44       LDA    $4,U		; [select_address]
FA38: ED 2C       STD    $C,Y
FA3A: A6 45       LDA    $5,U		; [select_address]
FA3C: A7 A8 10    STA    $10,Y
FA3F: A6 46       LDA    $6,U		; [select_address]
FA41: A7 A8 14    STA    $14,Y
FA44: A6 47       LDA    $7,U		; [select_address]
FA46: A7 A8 18    STA    $18,Y
FA49: A6 48       LDA    $8,U		; [select_address]
FA4B: A7 A8 1C    STA    $1C,Y
FA4E: A6 49       LDA    $9,U		; [select_address]
...
FA67: A6 4E       LDA    $E,U		; [select_address]
FA69: A7 A8 34    STA    $34,Y
FA6C: A6 4F       LDA    $F,U		; [select_address]
FA6E: A7 A8 38    STA    $38,Y
FA71: A6 C8 10    LDA    $10,U		; [select_address]
...
FACB: AA 41       ORA    $1,U		; [select_address]
...
FB0F: AA 41       ORA    $1,U		; [select_address]
...
FC7E: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=4]

FC88: A6 05       LDA    $5,X                                      
FC8A: 48          ASLA                                             
FC8B: CE FC 90    LDU    #jump_table_fc90
FC8E: 6E D6       JMP    [A,U]	; [indirect_jump] [nb_entries=12]
...
FD05: E7 1F       STB    -$1,X
FD07: 86 03       LDA    #$03
FD09: D6 E2       LDB    stack_save_00e2
FD0B: 26 02       BNE    $FD0F
FD0D: 86 01       LDA    #$01
FD0F: A7 1E       STA    -$2,X
...
FD23: E6 06       LDB    $6,X
FD25: 58          ASLB
FD26: EE C5       LDU    B,U		; [bank_address]
FD28: EF 1C       STU    -$4,X
FD2A: 6C 13       INC    -$D,X
FD2C: 39          RTS
...
FD43: EE C6       LDU    A,U		; [bank_address]
FD45: EF 1C       STU    -$4,X
