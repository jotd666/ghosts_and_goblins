...
7125: 8E 71 47    LDX    #$7147                                      
7128: D6 71       LDB    $71
712A: 27 08       BEQ    $7134
712C: D6 72       LDB    $72
712E: 58          ASLB
712F: 8E 71 39    LDX    #jump_table_7139
7132: AE 85       LDX    B,X
7134: D6 0B       LDB    $0B
7136: 58          ASLB
7137: 6E 95       JMP    [B,X]	; [indirect_jump] bogus???
...
C5E4: AD D5       JSR    [B,U]		; [indirect_jump_bogus]
...
D29F: 39          RTS
D2A0: 58          ASLB
D2A1: CE D2 A6    LDU    #$D2A6	; [indirect_jump]
D2A4: 6E D5       JMP    [B,U]
...
DE26: EC 13       LDD    -$D,X
DE28: 48          ASLA
DE29: 6E D6       JMP    [A,U]	; [indirect_jump_from_ram_table]
...
E798: E6 12       LDB    -$E,X
E79A: 58          ASLB
E79B: 6E D5       JMP    [B,U]	; [indirect_jump_from_ram_table]
E79D: 39          RTS
